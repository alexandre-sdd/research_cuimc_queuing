...
& m=0 & m=1 & \cdots & m=S-1 \\
\hline
r=0 \text{ (day }D\text{)} & Y_t(0,0) & Y_t(0,1) & \cdots & Y_t(0,S-1) \\
r=1 \text{ (day }D+1\text{)} & Y_t(1,0) & Y_t(1,1) & \cdots & Y_t(1,S-1) \\
\vdots & \vdots & \vdots & \ddots & \vdots \\
r=H-1 \text{ (day }D+H-1\text{)} & Y_t(H-1,0) & Y_t(H-1,1) & \cdots & Y_t(H-1,S-1)
\end{array}
\]
...
& m=0 & m=1 & m=2 & m=3 \\
\hline
r=0 \text{ (day }D\text{)} & 0 & (1,0,\varnothing) & 0 & (2,0,\varnothing) \\
r=1 \text{ (day }D+1\text{)} & (1,1,\varnothing) & 0 & (2,1,\varnothing) & 0 \\
r=2 \text{ (day }D+2\text{)} & 0 & (2,2,D+1) & (1,2,\varnothing) & 0
\end{array}
\]
